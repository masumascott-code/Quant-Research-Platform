...
export const signalsTable = pgTable("signals", {
  ...
  whyNow: text("why_now"),
  whyNotEarlier: text("why_not_earlier"),
  whyLong: text("why_long"),
  whySl: text("why_sl"),
  whyTp: text("why_tp"),
  trendScore: numeric("trend_score", { precision: 5, scale: 2 }),
  emaScore: numeric("ema_score", { precision: 5, scale: 2 }),
  volumeScore: numeric("volume_score", { precision: 5, scale: 2 }),
  rvolScore: numeric("rvol_score", { precision: 5, scale: 2 }),
  ...
  timeframeAlignment: text("timeframe_alignment"),
