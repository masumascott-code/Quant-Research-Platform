...
export function AppSidebar() {
  ...
  const routes = [
    ...
    },
    {
      label: "AI",
      items: [
        { name: "AI Dashboard", path: "/ai/dashboard", icon: Sparkles, role: "viewer" },
        { name: "AI Mentor", path: "/ai/mentor", icon: Bot, role: "viewer" },
        { name: "Trade Review", path: "/ai/trade-review", icon: Target, role: "viewer" },
        { name: "AI Journal", path: "/ai/journal", icon: MessageSquare, role: "viewer" },
        { name: "Daily Report", path: "/ai/daily-report", icon: CalendarDays, role: "viewer" },
        { name: "Weekly Report", path: "/ai/weekly-report", icon: CalendarRange, role: "viewer" },
        { name: "Market Summary", path: "/ai/market-summary", icon: Gauge, role: "viewer" },
        { name: "Strategy Review", path: "/ai/strategy-review", icon: BarChart2, role: "viewer" },
      ],
    },
    {
      label: "System",
